...
@mytag
Scenario Outline: Calculate area and perimeter of a square with negative input
		When we calculate the area and perimeter
       Then the area and perimeter should not be calculable due to the negative <Side>
	Examples:
        | Side |
        | -5   |
        | -10  |
